...
public class GatewayConfig {
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
            ...
            .route("scheduling_service_route", r -> r.path("/campushub-scheduling-service/**")
                .filters(f -> f.rewritePath("/campushub-scheduling-service/(?<remaining>.*)", "/${remaining}"))
                .uri("lb://campushub-scheduling-service"))
